...
def main(config):
    ...
    # load smpl model sequence data, which was generated by CLIFF
    series = MotionSeries("../scene_sequences/cxk_clip_cliff_hr48.npz")  # we don't override root_orient and trans in this case

    # the smpl models coords was in the camera coord-system, so we set R, T to zero
